...
typedef enum  //! This is the protocol that the palm is using for the tactile
              //! sensors.
...
{ AUX_SENSOR_PROTOCOL_TYPE_INVALID =
  ...
  AUX_SENSOR_PROTOCOL_TYPE_MCP3202 =
      0x0001,  //!< A basic MCP3202 ADC was found.
  AUX_SENSOR_PROTOCOL_TYPE_MCP3204 =
      0x0002,                                //!< A basic MCP3204 ADC was found.
...
{ TACTILE_SENSOR_TYPE_PST3_PRESSURE_TEMPERATURE =
      0x0000,  //!< 0: Pressure.       1: Temperature
  TACTILE_SENSOR_TYPE_PST3_PRESSURE_RAW_ZERO_TRACKING =
      0x0002,  //!< 0: Raw pressure    1: Zero tracking
...
typedef struct {
  ...
  // int16u  other_sensor_1;                               #ERROR NO! Do not
  // place this here
  ...
  int16u other_sensor_1;  // This is placed here to make this struct backwards
                          // compatible with older versions of the host side
                          // driver.
...
Sensor Tactile", "6 Axis"};
    ...
    static const char* tactile_sensor_manufacturer_strings[4] = {   "None",
                                                                    "Shadow
Robot Company Ltd.", "Syntouch", "Bielefeld University"};

    static const char* tactile_sensor_generic_info_strings[7] = {   "Invalid",
                                                                    "SVN
revision", "Revision is modified", "SVN revision on server at build time", "PCB
version", "Part serial number low", "Part serial number high"};
